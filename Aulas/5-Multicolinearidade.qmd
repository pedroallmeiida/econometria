...
relaçãi linear "perfeita" ou "quase perfeita" entre algumas variáveis
...
- Se a multicolinearidade for quase perfeita, alta, os coeficientes de regressão, embora determinados, possuirão grandes erros padrão, oquee significa que os coeficientes não podem ser estimados com grande precisão. 

##  [Quais as fontes de Multicolinearidade]{style="font-size: 40px;"} 

1. Erro na coleta dos dados 

2. Correlação entre as variáveis. Por exemplo, o consumo de energia elátrica ($X_1$) e o tamanho da casa ($X_2$), podem estar correlacionadas. 
...
- Mesmmo se a multicolinearidade for multo alta, como no caso da quase multicolinearidade, os estimadores de MQO ainda conservrão as propriedades de melhores estimadores não viesados. 
...
- Devido a consequência 1, os intervalos de confiância tendem a ser muito mais amplos, levando â aceitação imediata da hipótese nula igual a zero. O que implca que a estatistica do teste t dos coeficientes tende a ser estatisticamente não significantes. 
